...
extension OrderStatusMatch on OrderStatus {
  T match<T>(
      ...
      required T Function() confirmRemoverProduct,
    ...
    if (v == OrderStatus.confirmRemoverProduct) {
      return confirmRemoverProduct();
    }
  ...
  T matchAny<T>(
      ...
      T Function()? error,
      T Function()? confirmRemoverProduct,
      T Function()? emptyBag,
      T Function()? success}) {
    final v = this;
